...
# Other Parameters
tf.flags.DEFINE_string("classi", "anjiedaikuan", "The class to be trained")
...
x_train, title_train, y_train, train_beg, train_end, train_entity, train_sf = binary_data_helpers.load_data_and_labels(FLAGS.train_data)
...
x_train, train_pos, train_entity = binary_data_helpers.trigger2mid(x_train, train_beg, train_end, train_entity, FLAGS.sent_length)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir = os.path.abspath(os.path.join(os.path.curdir, "runs", FLAGS.classi, timestamp))
        print("Writing to {}\n".format(out_dir))
        ...
        # Generate batches
        batches = binary_data_helpers.batch_iter(
